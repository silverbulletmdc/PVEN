...
def make_basic_dataset(pkl_path, train_size, val_size, pad, re_prob=0.5, with_mask=False, for_vis=False):
    """
    构建基础数据集。
    """

    meta_dataset = datasets.CommonReIDDataset(pkl_path=pkl_path)
